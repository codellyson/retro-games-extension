...
async function load() {
  const s = await get(["theme", "showBookmarks", "best", "muted", "difficulty"]);
  ...
  bookmarksEl.checked = s.showBookmarks !== false;
...
bookmarksEl.addEventListener("change", () => set({ showBookmarks: bookmarksEl.checked }));
